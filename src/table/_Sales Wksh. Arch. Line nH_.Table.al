table 80442 "Sales Wksh. Arch. Line nH"
{
    Caption = 'Sales Worksheet Archive Line';
    DataClassification = SystemMetadata;

    fields
    {
        field(1; "Sales Worksheet Archive No."; Code[20])
        {
            Caption = 'Sales Worksheet Archive No.';
            DataClassification = SystemMetadata;
        ...
        field(50; "External Document No."; Text[35])
        {
    ...
    keys
    {
        key(Key1; "Sales Worksheet Archive No.", "Line No.")
        {
        }
        key(Key2; "Sales Worksheet Archive No.", "Document Created")
        {
        }
        key(Key3; "Sales Worksheet Archive No.", "Document Created", "Split By")
        {
        }
    }
    fieldgroups
    ...
    begin
        ...
        case(Rec."Document Type")of Rec."Document Type"::Order: NavigateToNotPostedDocument(PAGE::"Sales Order");
        Rec."Document Type"::Invoice: NavigateToNotPostedDocument(PAGE::"Sales Invoice");
        Rec."Document Type"::"Return Order": NavigateToNotPostedDocument(PAGE::"Sales Return Order");
        Rec."Document Type"::"Credit Memo": NavigateToNotPostedDocument(PAGE::"Sales Credit Memo");
        end;
    end;
